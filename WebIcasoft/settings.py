"""
Django settings for WebIcasoft project.
...
SECRET_KEY = 'django-insecure-j7$u6pm$r^yxv8g*-3(x(gr+17odh3x4u66)33a7!a()1aaq!d'
...
INSTALLED_APPS = [
    ...
    'django.contrib.sessions',  # si usas login/logout
...
WSGI_APPLICATION = 'WebIcasoft.wsgi.application'
